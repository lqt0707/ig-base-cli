...
var selectTpl = function () { return __awaiter(void 0, void 0, void 0, function () {
    var prompts, select, githubName, path, loadUrl, onEachAnswer, onError, onCompleted, tplList_1;
    return __generator(this, function (_a) {
        ...
        try {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            githubName = answer;
                            select = tplList_1.filter(function (tpl) { return tpl.name === answer; })[0];
            ...
            tplList_1 = (0, tpl_1.getTplList)();
            prompts.next({
                type: "list",
                message: "请选择模板:",
                name: "name",
                choices: tplList_1.map(function (tpl) { return tpl.name; }),
            });
        }
        catch (error) {
            (0, util_1.loggerError)(error);
