...
var request_1 = require("@/registry/gitlab/request");
/**
 * @description: 获取工程列表
...
var getProjectByUser = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, request_1.methodV)({
                        url: "/users/".concat(userId, "/projects"),
                        method: "GET",
                        query: {
                            per_page: pageSize,
                            page: pageNum,
...
var deleteProtectedBranches = function (projectId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                url = "/projects/".concat(projectId, "/protected_branches/master");
...
var protectedBranches = function (projectId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                url = "/projects/".concat(projectId, "/protected_branches");
                return [4 /*yield*/, (0, request_1.methodV)({
                        url: url,
                        method: "POST",
                        params: {
